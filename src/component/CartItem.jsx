    ...
    <div className="flex items-center py-4 gap-3">
        ...
        <div>
            ...
            <p className="flex gap-3 ">
                ...
                {!dialog && (<span className="text-rose-500">${(productCount * productPrice).toFixed(2)}</span>)}
            </p>
        </div>
        {!dialog && (
        ...
        {dialog && (<span className="text-rose-900 font-semibold ml-auto">${(productCount * productPrice).toFixed(2)}</span>)}
    </div>
)
